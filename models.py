...
class Campaign(Base):
    ...
    total_read: Mapped[int] = mapped_column(default=0)
    ...
    total_attributed_orders: Mapped[int] = mapped_column(default=0)
    total_attributed_revenue: Mapped[float] = mapped_column(default=0.0)
    created_at: Mapped[datetime] = mapped_column(default=datetime.utcnow)
...
class Message(Base):
    ...
    attributed_order: Mapped[bool] = mapped_column(default=False)
    attributed_at: Mapped[Optional[datetime]] = mapped_column(nullable=True)
